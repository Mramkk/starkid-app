...
@endsection
@section('page-title')
    <h5 id="page-title" class="card-title text-center">Addition</h5>
@endsection
@section('content')
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-md-4">
                                    <button id="btnSubmit" type="submit" style="width: 100% ; height:50px;"
                                        class="btn btn-primary   rounded-pill mt-3 shadow-lg"><b>Answer</b></button>
                                </div>
                            </div>
        ...
        function generateCalc() {
            ...
            if (digit == "1") {
                ...
                for (let i = 0; i < sum; i++) {
                    ...
                    //     } else if (last.toString().length == 7) {
                    //         nums[i] = generateRandomNumber(10000000, 99999999)
                    //     } else if (last.toString().length == 8) {
                    //         nums[i] = generateRandomNumber(100000000, 999999999)
                    //     } else {
                    //         nums[i] = generateRandomNumber(1, 9)
                    //     }
