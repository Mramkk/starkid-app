...
@endsection
@section('page-title')
    <h5 id="page-title" class="card-title text-center">Square Root</h5>
@endsection
@section('content')
                    ...
                    <div id="section2" class="container text-center mt-5">
                        ...
                        <form id="frm">
                            ...
                            <div class="row justify-content-center">
                                <input type="hidden" name="operation" value="Square Root">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#frm').submit(function(e) {
                ...
                sumCal = $('#txtcal').text();
                sumCal = Math.sqrt(sumCal).toFixed(1);
                $('#txtcans').val(sumCal)
                $('#txtnums').val($('#txtcal').text())
                let req = api.setFormData(api.url() + "/square", this);
