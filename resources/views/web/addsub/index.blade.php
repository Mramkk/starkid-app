...
@endsection
@section('page-title')
    <h5 id="page-title" class="card-title text-center">Add/Sub
    </h5>
@endsection
@section('content')
                    ...
                    <div id="section2" class="container text-center mt-5">
                        ...
                        <form id="frm">
                            ...
                            <div class="row justify-content-center">
                                <input type="hidden" name="operation" value="Add/Sub
                                ">
            ...
            if (digit == "1") {
                ...
                if (sum <= 8) {
                    ...
                    for (let i = 3; i < nums.length; i++) {
                        ...
                        } else if (nums[i].toString().length == 1) {
                            if (nums[i] <= 8) {
                                var x = nums[i];
                                x = -x;
                                nums[i] = x;
                ...
                if (sum <= 8) {
                    ...
                    for (let i = 3; i < nums.length; i++) {
                        ...
                        } else if (nums[i].toString().length == 2) {
                            if (nums[i] <= 50) {
                                var x = nums[i];
                                x = -x;
                                nums[i] = x;
                ...
                if (sum <= 8) {
                    for (let i = 0; i < sum; i++) {
                        if (i == 0) {
                            ...
                            } else if (last.toString().length == 4) {
                                if (primeNumber(i)) {
                                    nums[i] = generateRandomNumber(100, 999)
                                } else {
                                    let last = nums[nums.length - 1];
                    ...
                    for (let i = 3; i < nums.length; i++) {
                        if (nums[i].toString().length == 4) {
                            if (nums[i] <= 5000) {
                                var x = nums[i];
                                x = -x;
                                nums[i] = x;
                            }
                        } else if (nums[i].toString().length == 3) {
                            if (nums[i] <= 500) {
                                var x = nums[i];
                                x = -x;
                                nums[i] = x;
