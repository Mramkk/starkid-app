...
@endsection
@section('page-title')
    <h5 id="page-title" class="card-title text-center">Percentage</h5>
@endsection
@section('content')
                    ...
                    <div id="section2" class="container text-center mt-5">
                        ...
                        <form id="frm">
                            ...
                            <div class="row justify-content-center">
                                <input type="hidden" name="operation" value="Percentage">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#btnstart').click(function() {
                ...
                numsm[0] = generateDigit();
                numsm[1] = generateNumPercent();
                $('#strcal').hide();
            ...
            $('#frm').submit(function(e) {
                ...
                let num2 = numsm[1];
                // sumCal = num1 * num2;
                sumCal = percentage(num1, num2);

                $('#txtcans').val(sumCal + "%")
                $('#txtnums').val(num1 + "/" + num2 + "*100")
        ...
        function generateNumPercent() {
            let nums = [];
            nums[0] = generateRandomNumber(1, 100)
            return nums[0];
